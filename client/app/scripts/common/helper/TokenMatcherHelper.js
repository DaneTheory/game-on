...
app.factory('TokenMatcherHelper', function () {
	...
	// ```
	// 
	var replaceNamedTokens = function(template, data) {
	...
	// ```
	// 
	var replaceNumberedTokens = function(template, replacements) {
	...
	return {
		replaceNamedTokens: replaceNamedTokens,
		replaceNumberedTokens: replaceNumberedTokens
	}
