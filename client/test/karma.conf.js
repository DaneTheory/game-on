...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      'app/components/sass-bootstrap/js/collapse.js',
      'app/components/sass-bootstrap/js/transition.js',
      'app/components/sass-bootstrap/js/dropdown.js',
      'app/components/sass-bootstrap/js/carousel.js',
